...
const APP_WORKFLOWS = new Set([
  ...
  "report_auto2.yml", "produce_oddly.yml", "publish_oddly.yml", "build_asmr_library.yml", "daily_oddly.yml", "set_oddly_branding.yml", "clip_pd.yml", "clip_cc.yml", "clip_nasa.yml", "clip_wikimedia.yml", "clip_vimeo.yml", "clip_pixabay.yml", "clip_pexels.yml",
]);
