...
async function pick() {
  ...
  const parts = [{ text: `Editor de SHORTS. Miniaturas del video de NASA "${title}" con timestamp (s). Elige el momento MÁS espectacular/impactante (lanzamiento, planeta, fenómeno). Devuelve SOLO JSON: {"start": <s, menos 2>, "title": "título EN inglés de alto CTR (<=60)"}.` }];
