...
// Uso: node pipeline/plan_capacity.mjs <plan.txt> <occupiedCsv> <bufferHours> <queueOut.json>
...
const [planFile, occCsv, bufferArg, queueOut] = process.argv.slice(2);
...
const q = freeSlotsInWindow(occCsv || "", { bufferHours, dataHours });
